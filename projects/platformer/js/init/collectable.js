(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.db, 700, 300, 8, 0.7);
        collectable.create(type.max, 300, 200, 8, 0.7);
        collectable.create(type.grace, 400, 100, 8, 0.7);
        collectable.create(type.kennedi, 800, 220, 8, 0.7);
